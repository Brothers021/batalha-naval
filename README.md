...
## 🎮 Funcionalidades
- Tabuleiro de jogo com coordenadas
- Posicionamento de navios
- Registro de tiros e acertos
- Detecção de vitória (quando todos os navios de um jogador são afundados)

## 🛠️ Tecnologias utilizadas
- Linguagem: **[C#]**
- Ferramentas: GitHub, Git, vscode
